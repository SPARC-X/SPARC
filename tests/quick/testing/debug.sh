...
#LIBPCE_DEBUG_LEVEL=25 mpirun --np 4 ./sparc -name BaTiO3 | tee nl_ser.txt
#LIBPCE_DEBUG_LEVEL=5 mpirun -np 4 gdb -batch -ex=r -ex=bt -ex=q --args ./sparc -name BaTiO3
#LIBPCE_DEBUG_LEVEL=5 mpirun -np 2 gdb -batch -ex=r -ex=bt -ex=q --args ./sparc -name BaTiO3
LIBPCE_DEBUG_LEVEL=5 mpirun -np 4 ./sparc -name BaTiO3
